  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8 pt-20 sm:pt-28 pb-24 sm:pb-32">
        ...
        <Reveal delay={100}>
          <h1 className="mt-8 max-w-4xl font-display text-4xl sm:text-6xl font-semibold leading-[1.08] text-balance">
        ...
        <Reveal delay={260}>
          <p className="mt-6 max-w-2xl text-base sm:text-lg leading-relaxed text-parchment-dark/85">
            1869&rsquo;da yayımlanan ilk kadın dergisinden 1923&rsquo;e uzanan bir dönemde,
            kadınlara seslenen Osmanlı süreli yayınlarındaki şiddet temsillerini
            disiplinlerarası bir tipoloji ile ilk kez sistematik olarak inceleyen bir
            TÜBİTAK araştırması.
          </p>
        </Reveal>
